...
import { authMock, authMockRequest, authMockResponse, authUserPayload } from '@auth/controllers/test/mocks/auth.mocks';
import { read, resendEmail } from '@auth/controllers/current-user';
import * as auth from '@auth/services/service.auth';
import * as helper from '@adriand94/jobber-shared';
import { Sequelize } from 'sequelize';

jest.mock('@adriand94/jobber-shared');
jest.mock('@auth/services/service.auth');
